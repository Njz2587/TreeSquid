...
public class vThirdPersonCamera : MonoBehaviour
{
    ...
    */
    ...
    [Tooltip("Smooth out the culling jumps")]
    public float cullingSmoother = 1f;

    public bool isPlayerOneCam = true;
    
    public float rightOffset = 0f;
    public float defaultDistance = 2.5f;
    public float initialDefaultDistance;
    ...
    void Start()
    {
        initialDefaultDistance = defaultDistance;
        Init();
    }
    ...
    void CameraMovement()
    {
        ...
        //cullingDistance = Mathf.Lerp(cullingDistance, distance, cullingSmoother * Time.deltaTime);

...
public class LayeredAudioSource : ILayeredAudioSource 
{
	...
	/// <summary>
    /// (Constructor) Allocates the layer stack
    /// </summary>
    ...
    /// <summary>
    /// Called every frame, updates the time for all layered clips
    /// Makes sure that the audio source is playing the clip on the highest layer
    /// </summary>
	public void Update(  )
	{
